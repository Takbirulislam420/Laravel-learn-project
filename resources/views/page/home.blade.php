@extends('layout.app')
@section('title','Takbirul islam | Full-Stack Laravel Developer')
@section('content')
        <!-- Hero Section -->
                                ...
                                <div class="card border-0 shadow-sm glass-card">
                                    <div class="card-body text-center p-5">
                                        ...
                                        <blockquote class="blockquote mb-3">
                                            <p class="lead">"Atik delivered an exceptional e-commerce platform that exceeded our expectations. His attention to detail and technical expertise helped us increase our online sales by 150%."</p>
                                        </blockquote>
                            ...
                            <div class="col-lg-8">
                                <div class="card border-0 shadow-sm glass-card">
                                    <div class="card-body text-center p-5">
                                        ...
                                        <blockquote class="blockquote mb-3">
                                            <p class="lead">"Working with Atik was a game-changer for our startup. He built a scalable Laravel API that handles thousands of requests daily without any issues. Highly recommended!"</p>
                                        </blockquote>
                                        <footer class="blockquote-footer">
                            ...
                            <div class="col-lg-8">
                                <div class="card border-0 shadow-sm glass-card">
                                    <div class="card-body text-center p-5">
                                        ...
                                        <blockquote class="blockquote mb-3">
                                            <p class="lead">"The restaurant management system Atik developed has streamlined our operations completely. Order processing time reduced by 40% and customer satisfaction improved significantly."</p>
                                        </blockquote>
                                        <footer class="blockquote-footer">
